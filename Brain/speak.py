...
def Introduction():
    ...
    try:
        driver.find_element(By.XPATH,"/html/body/div/main/div/div/div[1]/div[4]/div/div[2]/div/div/textarea").send_keys("Introducion")
    
    except:
        driver.find_element(By.XPATH,"/html/body/div/main/div/div/div[1]/div[4]/div/div/div/div/textarea").send_keys("Introducion")

    sleep(1)
    driver.find_element(By.XPATH,"/html/body/div/main/div/div/div[1]/div[4]/div/div/div/button").click()
    sleep(1)
    driver.find_element(By.XPATH,"/html/body/div/main/div/div/div[2]/div/div[2]/button").click()
    sleep(1)
...
Id=os.environ.get("_FB_ID")
Passcode = os.environ.get("_FB_PASS")
